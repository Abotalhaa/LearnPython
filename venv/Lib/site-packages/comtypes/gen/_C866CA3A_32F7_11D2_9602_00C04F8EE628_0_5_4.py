...
__all__ = [
    'DISPID_SPRuleConfidence', 'SpObjectToken', 'DISPID_SRAudioInput',
    'SPCT_DICTATION', 'SVEAudioLevel', 'DISPID_SGRSTs_NewEnum',
    'SAFT8kHz8BitStereo', 'SpSharedRecognizer',
    'DISPID_SpeechPhraseElements', 'SAFT22kHz8BitMono',
    'tagSPPROPERTYINFO', 'SVP_10', 'eLEXTYPE_PRIVATE5',
    'SAFTGSM610_44kHzMono', 'SpeechDisplayAttributes', 'SREAllEvents',
    'ISpRecognizer', 'DISPID_SRGId', 'DISPID_SRGSetTextSelection',
    'SRERecoOtherContext', 'DISPID_SRCERequestUI',
    'SpeechRegistryUserRoot', 'ISpeechGrammarRuleStateTransition',
    'SAFT24kHz16BitStereo', 'DISPID_SRRRecoContext', 'SASClosed',
    'eLEXTYPE_PRIVATE18', 'SWPUnknownWordUnpronounceable',
    ...
    'SPDATAKEYLOCATION', 'SpeechGrammarWordType',
    'DISPID_SPRules_NewEnum', 'DISPID_SVAudioOutputStream',
    'STCInprocServer', 'SVSFVoiceMask',
    'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SGRSAddSpecialTransition', 'STSF_FlagCreate',
    'SVSFPersistXML', 'ISpMMSysAudio', 'SAFT12kHz16BitStereo',
    'SPFM_OPEN_READONLY', 'ISequentialStream',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SFSOpen',
    'SpeechRecognitionType', 'DISPID_SRGetRecognizers',
    'SPEI_UNDEFINED', 'DISPID_SpeechFileStream', 'SPPHRASEELEMENT',
    'SpStream', 'SpeechAddRemoveWord', 'SpeechGrammarState',
    'SASPause', 'ISpNotifyTranslator', 'ISpRecoContext',
    'DISPID_SCSBaseStream', 'SPBINARYGRAMMAR',
    'DISPID_SLGenerationId', 'SpeechVisemeFeature',
    'ISpResourceManager', 'SPBOOKMARKOPTIONS',
    'ISpeechRecoResultDispatch', 'SPGRAMMARSTATE', 'SP_VISEME_0',
    'ISpStreamFormatConverter', 'eLEXTYPE_RESERVED7',
    'DISPID_SLGetGenerationChange', 'DISPID_SGRsItem', 'SPWORD',
    'DISPID_SPIRetainedSizeBytes', 'SpVoice', 'DISPID_SAStatus',
    'SVEAllEvents', 'DISPID_SOTMatchesAttributes',
    ...
    'DISPID_SPPParent', 'SECLowConfidence', 'DISPID_SPPsItem',
    'SVP_9', 'DISPID_SRGCommit', 'DISPID_SRCEPropertyNumberChange',
    'eLEXTYPE_PRIVATE2', 'SPWT_DISPLAY', 'SAFTCCITT_uLaw_8kHzStereo',
    'SPEI_FALSE_RECOGNITION', 'SRCS_Disabled',
    'SWPKnownWordPronounceable', 'SAFTText',
    'SpeechStreamSeekPositionType', 'DISPID_SpeechAudioFormat',
    'DISPID_SRCEventInterests', 'DISPID_SBSFormat',
    'SAFTGSM610_22kHzMono', 'SAFT44kHz16BitMono', 'ISpStream',
    'DISPID_SVVolume', 'SpeechPropertyLowConfidenceThreshold',
    'SpeechAudioVolume', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SPPChildren', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SRAudioInputStream', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SPCONTEXTSTATE', 'SVP_5', 'SPLOADOPTIONS', 'SpeechVisemeType',
    'ISpeechFileStream', 'DISPID_SAEventHandle', 'ISpeechRecognizer',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SRRTOffsetFromStart',
    'SPPS_Noncontent', 'ISpeechLexiconPronunciation',
    'SAFTNoAssignedFormat', 'SSFMCreateForWrite', 'ISpEventSource',
    'DISPID_SDKEnumValues', 'DISPID_SpeechRecoResult2',
    'STSF_AppData', 'ISpeechPhraseRule', 'SPSEMANTICFORMAT',
    'SVSFParseSsml', 'ISpeechVoiceStatus', 'SPPS_RESERVED3',
    'SVEStartInputStream', 'SRERequestUI', 'eWORDTYPE_DELETED',
    'SpeechFormatType', 'SVEWordBoundary',
    ...
    'DISPID_SFSClose', 'SpeechCategoryAppLexicons',
    'ISpeechRecoResult', 'SpeechVoiceEvents', 'DISPID_SPRuleName',
    'eLEXTYPE_RESERVED6', 'SPXRO_SML', 'SPPS_Unknown',
    'eWORDTYPE_ADDED', 'ISpDataKey', 'SASStop', 'DISPID_SPAsCount',
    'DISPID_SPAs_NewEnum', 'DISPID_SGRClear', 'SRSInactive',
    'DISPID_SPPEngineConfidence', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SpeechStreamFileMode', 'STCRemoteServer', 'DISPID_SRProfile',
    'SVP_16', 'DISPID_SWFEBitsPerSample', 'eLEXTYPE_RESERVED4',
    'SAFT12kHz8BitStereo', 'DISPID_SDKOpenKey',
    'DISPID_SPEPronunciation', 'ISpeechPhraseProperties',
    'DISPID_SpeechLexicon', 'DISPID_SGRsCount', 'SPSInterjection',
    'DISPID_SOTDataKey', 'DISPID_SVAudioOutput', 'SPWT_PRONUNCIATION',
    'SLTUser', 'SpeechTokenKeyFiles', 'DISPID_SpeechCustomStream',
    'SAFTCCITT_ALaw_22kHzStereo', '_RemotableHandle',
    'DISPID_SpeechPhraseProperties', 'ISpeechWaveFormatEx',
    'DISPID_SRRTimes', 'ISpeechPhraseElements', 'SAFT8kHz16BitMono',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SLWType', 'SVP_19', 'DISPID_SpeechObjectToken',
    'DISPID_SRCEStartStream', 'ISpShortcut',
    'ISpeechGrammarRuleState', 'DISPID_SPIGrammarId',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SWFEAvgBytesPerSec',
    'SREAudioLevel', 'SPRST_ACTIVE', 'SPINTERFERENCE',
    'ISpeechGrammarRuleStateTransitions', 'ISpObjectWithToken',
    'SAFT32kHz16BitMono', 'SVP_4', 'SPINTERFERENCE_NOISE',
    'SP_VISEME_4', 'SPCT_SUB_COMMAND', 'ISpStreamFormat',
    'SP_VISEME_21', 'SAFT11kHz16BitStereo', 'SVP_20',
    'SpeechRuleState', 'SPEI_MAX_TTS', 'SLTApp', 'SAFT8kHz8BitMono',
    'DISPID_SGRSTPropertyName', 'DISPID_SPPName',
    'SAFTADPCM_8kHzMono', 'DISPID_SpeechVoice', 'SP_VISEME_2',
    'SREPropertyStringChange', 'DISPID_SRRTStreamTime', 'SPSHT_OTHER',
    'SpeechBookmarkOptions', 'IStream', 'SPEVENT',
    'DISPID_SRCCmdMaxAlternates', 'SPVOICESTATUS',
    'SPINTERFERENCE_NONE', 'SVEBookmark', 'SRAONone',
    'DISPID_SRGCmdSetRuleIdState', 'SITooLoud', 'DISPID_SGRSTsItem',
    'SPRULE', 'DISPID_SDKCreateKey', 'SpeechRetainedAudioOptions',
    'DISPID_SVSPhonemeId', 'SPSERIALIZEDPHRASE',
    'ISpeechCustomStream', 'DISPID_SpeechGrammarRule',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SRSClsidEngine',
    'SPAS_STOP', 'SPEI_RECO_STATE_CHANGE', 'STSF_CommonAppData',
    'DISPID_SpeechMemoryStream', 'SPFM_CREATE', 'DISPID_SBSWrite',
    'DISPIDSPTSI_SelectionOffset', 'SPSHORTCUTPAIR',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SPELexicalForm',
    'ISpeechRecoGrammar', 'SLOStatic', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SPRuleChildren', 'SpUnCompressedLexicon', 'SBONone',
    'SRSActiveAlways', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SMSSetData', 'DISPID_SPIStartTime', 'SDTAll',
    'DISPID_SLPsItem', 'STCAll', 'DISPID_SOTCategory', 'SpMMAudioOut',
    'DISPID_SpeechVoiceStatus', 'SRAImport', 'DISPID_SVEViseme',
    'SpeechPropertyAdaptationOn',
    'SpeechPropertyNormalConfidenceThreshold', 'SP_VISEME_18',
    'eLEXTYPE_USER', 'DISPID_SPACommit', 'ISpObjectTokenCategory',
    'SSFMCreate', 'DISPID_SPIEngineId', 'SDTAlternates',
    'SSSPTRelativeToEnd', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'ISpeechLexiconWords', 'SVP_13', 'SITooFast',
    'SAFTNonStandardFormat', 'SGPronounciation',
    'SAFTGSM610_8kHzMono', 'SPEI_SR_AUDIO_LEVEL',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SRGCmdLoadFromResource',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SVDisplayUI',
    'SPSMF_SAPI_PROPERTIES', 'SPEI_SR_PRIVATE',
    'DISPID_SWFESamplesPerSec', 'DISPID_SRRSaveToMemory',
    'DISPID_SLPs_NewEnum', 'ISpRecognizer2', 'DISPID_SABufferInfo',
    'SpNotifyTranslator', 'DISPID_SPERetainedSizeBytes',
    'SAFTADPCM_11kHzStereo', 'SpeechTokenKeyAttributes',
    'ISpeechRecoResult2', 'SAFT22kHz16BitStereo',
    'DISPID_SVAlertBoundary', 'SPRECORESULTTIMES',
    'DISPID_SRCEAudioLevel', 'DISPID_SPRuleFirstElement',
    'DISPID_SPAStartElementInResult', 'SPBO_NONE',
    'SpeechDictationTopicSpelling', 'SpeechDataKeyLocation',
    'SREBookmark', 'SDKLCurrentConfig', 'SAFT44kHz8BitMono',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SOTsCount', 'SECFIgnoreCase',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SGRSTNextState',
    'DISPID_SVResume', 'SECFEmulateResult', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SGRSRule', 'DISPID_SLGetPronunciations',
    'DISPID_SRSAudioStatus', 'DISPID_SRRSpeakAudio',
    'DISPID_SPERequiredConfidence', 'SpResourceManager',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SpeechAudio',
    'SpMMAudioEnum', 'SPEI_PROPERTY_NUM_CHANGE', 'SINoSignal',
    'DISPID_SOTGetDescription', 'DISPID_SDKGetBinaryValue', 'SDTRule',
    'DISPID_SPRNumberOfElements', 'DISPID_SPEsCount',
    'SPEI_SOUND_START', 'SpeechInterference', 'SPAUDIOSTATE',
    'ISpRecoGrammar2', 'DISPID_SPRulesItem', 'DISPID_SRState',
    'DISPID_SRCRequestedUIType', 'SPWORDLIST',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SVEventInterests',
    'DISPID_SDKGetlongValue', 'SRAORetainAudio', 'SVSFDefault',
    'SPPS_Noun', 'ISpeechTextSelectionInformation',
    'SAFTADPCM_8kHzStereo', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SRRAudio', 'SPWF_INPUT', 'DISPID_SVSCurrentStreamNumber',
    'SPWT_LEXICAL', 'SSTTWildcard', 'SpeechCategoryPhoneConverters',
    'SP_VISEME_5', 'DISPID_SDKEnumKeys', 'eLEXTYPE_PRIVATE19',
    'DISPID_SGRSAddWordTransition', 'DISPID_SRRAlternates',
    'DISPID_SVSInputSentencePosition', 'SP_VISEME_15',
    'DISPID_SpeechLexiconPronunciation', 'STCLocalServer',
    'DISPID_SpeechRecognizer', 'SPPS_Interjection', 'SPEI_RESERVED5',
    'SPBO_TIME_UNITS', 'DISPID_SDKDeleteKey', 'DISPID_SDKDeleteValue',
    'DISPID_SRCEEnginePrivate', 'DISPID_SRGCmdLoadFromObject',
    'SPSHORTCUTPAIRLIST', 'eLEXTYPE_PRIVATE8', 'SpCustomStream',
    'SGRSTTDictation', 'SSFMOpenForRead', 'DISPID_SRGReset',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SPSSuppressWord',
    'SPRULESTATE', 'SPCS_ENABLED', 'DISPID_SVEStreamStart',
    'DISPID_SOTRemove', 'SAFTDefault', 'SVSFIsXML',
    'SGDSActiveUserDelimited', 'SVSFIsNotXML', 'DISPID_SPAsItem',
    'DISPID_SPIGetDisplayAttributes', 'SpInProcRecoContext',
    'DISPID_SPEDisplayText', 'SRSInactiveWithPurge',
    'SpeechRecoProfileProperties', 'SVF_Stressed', 'SPVISEMES',
    '_ISpeechVoiceEvents', 'DISPID_SGRsDynamic',
    'SAFT44kHz16BitStereo', 'SPFILEMODE', 'SREPropertyNumChange',
    'SAFT32kHz16BitStereo', 'WAVEFORMATEX', 'DISPID_SLWs_NewEnum',
    'ISpeechPhraseElement', 'eLEXTYPE_PRIVATE10',
    'SPEI_END_SR_STREAM', 'DISPID_SRCCreateGrammar',
    'DISPID_SpeechBaseStream', 'SPPS_Function', 'SECFIgnoreWidth',
    'SPSNoun', 'SPAO_RETAIN_AUDIO', 'SPPHRASERULE', 'SVP_15',
    'SGSEnabled', 'DISPID_SRGState', 'SGRSTTRule', 'DISPID_SPRsItem',
    'DISPID_SVSLastStreamNumberQueued', 'SSFMOpenReadWrite',
    'DISPID_SPRulesCount', 'SP_VISEME_7', 'DISPID_SOTIsUISupported',
    'SpeechTokenContext', 'SPDKL_DefaultLocation', 'SP_VISEME_14',
    ...
    'SGRSTTWildcard', 'SPPS_RESERVED4',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SVP_11', 'DISPID_SMSALineId',
    'SITooSlow', 'SPXMLRESULTOPTIONS', 'DISPIDSPTSI',
    'SpeechTokenShellFolder', 'DISPID_SPRuleEngineConfidence',
    'ISpPhoneticAlphabetSelection', 'ISpPhoneConverter',
    'DISPID_SVEEnginePrivate', 'DISPID_SAFGuid', 'ISpeechRecoContext',
    'SRAInterpreter', 'DISPID_SPARecoResult', 'SPPS_SuppressWord',
    'SAFT22kHz8BitStereo', 'ISpeechPhraseProperty', 'SPAR_Low',
    'SPEI_MIN_TTS', 'DISPID_SRGDictationLoad',
    'DISPID_SRCEAdaptation', 'DISPID_SPIAudioSizeTime', 'SP_VISEME_1',
    'SDKLCurrentUser', 'SPEI_WORD_BOUNDARY', 'SP_VISEME_20', 'SVP_17',
    'DISPID_SRCreateRecoContext', 'eLEXTYPE_RESERVED9',
    'DISPID_SRRGetXMLResult', 'DISPID_SpeechPhraseAlternates',
    'SAFTExtendedAudioFormat', 'SPWORDPRONUNCIATIONLIST',
    'STCInprocHandler', 'SpeechCategoryAudioOut', 'SRTEmulated',
    'ISpeechPhraseAlternates', 'SVP_2', 'DISPID_SGRSTsCount',
    'SpWaveFormatEx', 'DISPID_SAVolume', 'SSTTTextBuffer',
    'DISPID_SDKSetBinaryValue', 'DISPID_SRGRecoContext',
    'SpeechPartOfSpeech', 'eLEXTYPE_APP', 'SPSHT_NotOverriden',
    'Speech_Max_Pron_Length', 'SPEVENTENUM', 'DISPID_SVSLastResult',
    'DISPID_SPIReplacements', 'DISPID_SVWaitUntilDone',
    'SpeechUserTraining', 'ISpRecoContext2',
    'DISPID_SAFGetWaveFormatEx', 'SAFT48kHz16BitStereo',
    'eLEXTYPE_PRIVATE16', 'DISPID_SpeechAudioStatus', 'SpMMAudioIn',
    'ISpAudio', 'SPEI_VOICE_CHANGE', 'DISPID_SAFType',
    'SPADAPTATIONRELEVANCE', 'SAFTGSM610_11kHzMono',
    'Speech_Default_Weight', 'ISpSerializeState',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SRCESoundEnd', 'SPAS_RUN',
    'SPWORDTYPE', 'SDA_Two_Trailing_Spaces', 'DISPID_SGRSTPropertyId',
    'ISpeechPhraseAlternate', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SRSNumberOfActiveRules', 'SFTSREngine', 'DISPID_SPIRule',
    'SREAdaptation', 'SVEViseme', 'DISPID_SpeechPhoneConverter',
    'SVP_6', 'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SABIEventBias',
    'DISPID_SOTCreateInstance', 'eLEXTYPE_RESERVED8',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SPIProperties',
    'DISPID_SpeechLexiconWords', 'SPEI_RESERVED1', 'SPAUDIOOPTIONS',
    'SPEI_RESERVED2', 'DISPID_SGRInitialState', 'DISPID_SVVoice',
    'ISpeechGrammarRules', 'DISPID_SPRFirstElement',
    'SPFM_OPEN_READWRITE', 'DISPID_SLPType', 'DISPID_SVEStreamEnd',
    'SPSHORTCUTTYPE', 'SVESentenceBoundary', 'SPEI_END_INPUT_STREAM',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SGRsCommit', 'SVP_21',
    'SPEI_TTS_BOOKMARK', 'SAFTCCITT_ALaw_22kHzMono', 'SGDSActive',
    'SpeechGrammarTagWildcard', 'SpeechRegistryLocalMachineRoot',
    'SAFT48kHz8BitStereo', 'ISpeechLexiconPronunciations',
    'SPSUnknown', 'SFTInput', 'SITooQuiet', 'SPINTERFERENCE_TOOLOUD',
    'SPSVerb', 'ISpeechDataKey', 'SAFT12kHz16BitMono',
    'ISpGrammarBuilder', 'DISPID_SVSLastBookmark',
    'DISPID_SVGetAudioOutputs', 'DISPID_SAFSetWaveFormatEx',
    'eLEXTYPE_PRIVATE4', 'SP_VISEME_6', '__MIDL_IWinTypes_0009',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SRESoundEnd',
    'ISpeechAudio', 'DISPID_SRCRetainedAudio', 'SGRSTTEpsilon',
    'SVSFNLPSpeakPunc', 'SpeechAudioFormatGUIDWave',
    'DISPID_SRSetPropertyNumber', 'ISpPhrase',
    'DISPID_SVSInputWordPosition', 'DISPID_SOTGetAttribute',
    'SRTReSent', 'SpeechVoiceSkipTypeSentence', 'DISPID_SRRTLength',
    'SPEI_RESERVED3', 'SpCompressedLexicon', 'SAFT16kHz8BitMono',
    'ISpeechObjectToken', 'IEnumString', 'DISPID_SOTDisplayUI',
    'SpeechSpecialTransitionType', 'SVP_12', 'ISpeechAudioBufferInfo',
    'DISPID_SpeechPhraseRule', 'SPSERIALIZEDRESULT',
    'SAFT11kHz16BitMono', 'ISpVoice', 'SVP_1', 'DISPID_SGRSTText',
    'SpeechWordPronounceable', 'DISPID_SpeechPhraseElement',
    'DISPID_SRIsShared', 'SPSModifier', 'SPINTERFERENCE_TOOFAST',
    ...
    'DISPID_SRCResume', 'SINoise', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SGRName', 'DISPID_SASFreeBufferSpace',
    'DISPID_SpeechMMSysAudio', 'ISpeechVoice', 'SPGS_DISABLED',
    'SP_VISEME_12', 'DISPID_SGRAddResource',
    'DISPID_SVESentenceBoundary', 'DISPID_SWFEExtraData', 'SVPNormal',
    'DISPID_SpeechGrammarRules', 'SLODynamic', 'SAFT48kHz16BitMono',
    'SPRS_INACTIVE', 'DISPID_SGRAddState', 'SRADefaultToActive',
    'SDTLexicalForm', 'SP_VISEME_10', 'SVEEndInputStream',
    'DISPID_SVIsUISupported', 'SP_VISEME_8', 'DISPID_SRRPhraseInfo',
    'eLEXTYPE_PRIVATE6', 'SPRECOGNIZERSTATUS', 'SPGS_EXCLUSIVE',
    'DISPID_SOTs_NewEnum', 'SDTDisplayText', 'SGRSTTTextBuffer',
    'ISpeechMMSysAudio', 'SRTAutopause', 'ISpRecoResult',
    'SPRECOSTATE', 'DISPID_SLPsCount', 'eLEXTYPE_PRIVATE9',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SMSADeviceId',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SPEI_MAX_SR',
    'SPEI_RECOGNITION', 'ISpeechObjectTokens',
    ...
    'DISPID_SPRs_NewEnum', 'SGDSInactive', 'SVF_None',
    'DISPID_SVSpeakCompleteEvent', 'SPTEXTSELECTIONINFO',
    'SVSFNLPMask', 'SAFT24kHz16BitMono', 'DISPID_SVStatus',
    'SP_VISEME_13', 'SPWORDPRONUNCIATION', 'DISPID_SVPause',
    'DISPID_SPRuleParent', 'SpeechTokenKeyUI',
    'DISPID_SRRGetXMLErrorInfo', 'SPEI_SOUND_END', 'SP_VISEME_9',
    'SWTAdded', 'ISpRecognizer3', 'SAFTADPCM_11kHzMono',
    'SpSharedRecoContext', 'DISPID_SPCLangId', 'DISPID_SVEPhoneme',
    'SPCT_SLEEP', 'SDA_Consume_Leading_Spaces',
    'SAFTADPCM_44kHzStereo', 'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SOTCDefault', 'SPGRAMMARWORDTYPE',
    'DISPID_SRGetPropertyNumber', 'DISPID_SPISaveToMemory',
    'DISPID_SpeechPhraseRules', 'DISPID_SDKSetStringValue',
    'DISPID_SpeechPhraseBuilder', 'SPLO_STATIC',
    'DISPID_SPAPhraseInfo', 'DISPID_SLAddPronunciation',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SRGetFormat',
    'DISPID_SRCState', 'SPBO_AHEAD', 'SRCS_Enabled',
    'ISpeechRecognizerStatus', 'ISpeechAudioFormat',
    'SAFT24kHz8BitMono', 'SVEPrivate', 'DISPID_SOTCSetId',
    'DISPID_SRCESoundStart', 'DISPID_SVSInputSentenceLength',
    'SSSPTRelativeToStart', 'eLEXTYPE_PRIVATE7', 'SpeechAudioState',
    'ISpPhraseAlt', 'eLEXTYPE_PRIVATE1', 'SP_VISEME_11',
    'ISpNotifySource', 'ISpeechPhraseRules', 'SDTProperty',
    'DISPID_SpeechLexiconProns', 'SRTStandard', 'SP_VISEME_17',
    'DISPID_SPCIdToPhone', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SGRsAdd', 'SVP_14', 'SVP_18', 'SRERecognition', 'SVPOver',
    'SAFT22kHz16BitMono', 'DISPID_SVEAudioLevel', 'DISPID_SOTId',
    'ISpeechRecoResultTimes', 'SPSLMA', 'SPVPRI_NORMAL',
    'DISPID_SpeechDataKey', 'DISPID_SGRSTRule',
    'DISPID_SpeechPhraseReplacements', 'SGSExclusive',
    'SpNullPhoneConverter', 'SPRST_INACTIVE',
    'SGDSActiveWithAutoPause', 'SPCATEGORYTYPE', 'SRADynamic',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SGRSTPropertyValue',
    'SPCS_DISABLED', 'SpeechMicTraining', 'ISpRecoCategory',
    'DISPID_SpeechRecoResultTimes', 'SRTExtendableParse',
    'DISPID_SRSetPropertyString', 'SpPhoneticAlphabetConverter',
    'DISPID_SASetState', 'DISPID_SPIEnginePrivateData',
    'ISpeechLexiconWord', 'SPWF_SRENGINE', 'SPEI_TTS_PRIVATE',
    'DISPID_SPEEngineConfidence', 'SPAUDIOSTATUS',
    'DISPID_SWFEFormatTag', 'SpeechTokenIdUserLexicon',
    'DISPID_SGRsFindRule', 'DISPID_SRSCurrentStreamPosition',
    'tagSTATSTG', 'DISPID_SRCSetAdaptationData', 'SVF_Emphasis',
    'DISPID_SPRDisplayAttributes', 'DISPID_SPEActualConfidence',
    'SpeechAudioFormatType', 'DISPID_SLRemovePronunciation',
    'SP_VISEME_19', 'DISPID_SRCRecognizer',
    'SpeechAudioFormatGUIDText', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SPEsItem', 'DISPID_SPPsCount', 'DISPID_SLWsCount',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SVSVisemeId',
    'SPEI_SR_BOOKMARK', 'DISPID_SOTsItem', 'DISPID_SLWLangId',
    'SRESoundStart', 'SWPUnknownWordPronounceable',
    'DISPID_SABufferNotifySize', 'SVP_0', 'SRARoot', 'SPAR_Medium',
    'DISPID_SOTSetId', 'SAFT24kHz8BitStereo', 'ISpeechAudioStatus',
    'DISPID_SGRSTWeight', 'SPPARTOFSPEECH', 'ISpLexicon', 'SVP_7',
    'DISPID_SASState', 'DISPID_SVSkip', 'DISPID_SWFEBlockAlign',
    'DISPID_SPPConfidence', 'DISPID_SRGRules',
    'SpeechCategoryAudioIn', 'SpeechPropertyResponseSpeed',
    'eLEXTYPE_PRIVATE3', 'SRATopLevel', 'DISPID_SRRTTickCount',
    'DISPID_SOTCGetDataKey', 'ISpEventSink',
    'SpeechPropertyComplexResponseSpeed', 'SpeechRecoContextState',
    'SDKLDefaultLocation', 'SPPS_Modifier', 'DISPID_SBSSeek',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SOTCEnumerateTokens', 'ISpeechMemoryStream',
    'DISPID_SRRDiscardResultInfo', 'SPSHT_Unknown',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SPANumberOfElementsInResult',
    'SREFalseRecognition', 'SpTextSelectionInformation',
    'DISPID_SLWsItem', 'SECFIgnoreKanaType', 'DISPID_SRCERecognition',
    'DISPID_SASCurrentSeekPosition', 'SAFTTrueSpeech_8kHz1BitMono',
    'SAFTCCITT_uLaw_44kHzMono', 'SPINTERFERENCE_TOOSLOW',
    'SAFT11kHz8BitStereo', 'SECNormalConfidence', 'LONG_PTR',
    'DISPID_SRCEBookmark', 'SPEI_REQUEST_UI',
    'SpeechEngineConfidence', 'SAFTCCITT_ALaw_8kHzMono',
    'SPSEMANTICERRORINFO', 'SAFTCCITT_uLaw_22kHzMono',
    'SRTSMLTimeout', 'SAFT44kHz8BitStereo',
    'ISpeechObjectTokenCategory', 'SpeechEmulationCompareFlags',
    'SPWAVEFORMATTYPE', 'DISPID_SVRate', 'SpeechGrammarTagDictation',
    'DISPID_SVEWord', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SPPNumberOfElements',
    'DISPID_SLAddPronunciationByPhoneIds', 'SPFM_NUM_MODES',
    'DISPID_SVGetProfiles', 'UINT_PTR', 'DISPID_SPILanguageId',
    'SPEI_TTS_AUDIO_LEVEL', 'SpPhoneConverter',
    'SpeechAudioProperties', 'eLEXTYPE_PRIVATE11',
    'DISPID_SpeechLexiconWord', 'SpShortcut', 'DISPID_SRCEEndStream',
    'DISPID_SpeechPhraseReplacement', 'ISpeechPhoneConverter',
    'SRSEDone', 'SVEVoiceChange', 'DISPID_SREmulateRecognition',
    'DISPID_SVGetVoices', 'SpeechEngineProperties', 'SPEI_HYPOTHESIS',
    'DISPID_SLPPhoneIds', 'SGLexicalNoSpecialChars', 'SPAO_NONE',
    'DISPID_SPEAudioSizeTime', 'ISpNotifySink', 'SGDisplay',
    'SPEI_START_SR_STREAM', 'SWTDeleted',
    'SPEI_PROPERTY_STRING_CHANGE', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SRDisplayUI', 'DISPID_SRSSupportedLanguages',
    'DISPID_SWFEChannels', 'DISPID_SPRuleId', 'DISPID_SRCEHypothesis',
    'SPSHT_EMAIL', 'eLEXTYPE_MORPHOLOGY', 'SPRS_ACTIVE',
    'SpeechVoiceSpeakFlags', 'SpeechAllElements',
    'SPPHRASEREPLACEMENT', 'SREStreamEnd', 'SECHighConfidence',
    'DISPID_SLPPartOfSpeech', 'DISPID_SRGIsPronounceable',
    'SpMemoryStream', 'SPAS_CLOSED', 'SGLexical', 'SDTPronunciation',
    'DISPID_SVSLastBookmarkId', 'DISPID_SVSpeak',
    'DISPID_SPIAudioStreamPosition', 'SAFT16kHz16BitMono',
    'SPEI_PHONEME', 'ISpPhoneticAlphabetConverter',
    'DISPID_SPCPhoneToId', 'DISPID_SpeechGrammarRuleStateTransition',
    'SBOPause', 'DISPID_SPPBRestorePhraseFromMemory',
    'SAFT8kHz16BitStereo', 'SREStreamStart', 'SPDKL_LocalMachine',
    'SAFT16kHz8BitStereo', 'SPEI_RESERVED6',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SLWWord',
    'Speech_Max_Word_Length', 'DISPID_SASNonBlockingIO',
    'DISPID_SPPValue', 'ISpRecoGrammar', 'DISPID_SRIsUISupported',
    'SDTAudio', 'SpeechRuleAttributes', 'SGRSTTWord',
    'DISPID_SpeechPhraseProperty', 'SRSActive',
    'SAFTCCITT_uLaw_11kHzMono', 'ISpeechPhraseInfo',
    'SPRST_NUM_STATES', 'SPDKL_CurrentUser', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SDKGetStringValue', '_SPAUDIOSTATE', 'ISpeechBaseStream',
    'SPCT_COMMAND', 'SPGS_ENABLED', 'DISPID_SRGDictationUnload',
    'SINone', 'SREHypothesis', 'SPPS_LMA', 'eLEXTYPE_PRIVATE20',
    ...
    'SAFT11kHz8BitMono', 'DISPID_SRRecognizer', 'SpLexicon',
    ...
    '_ISpeechRecoContextEvents', 'SGSDisabled', 'IEnumSpObjectTokens',
    'SPRECOCONTEXTSTATUS', 'ISpeechGrammarRule',
    'DISPID_SpeechRecoContext', 'SREInterference', 'DISPID_SPPId',
    'SAFT48kHz8BitMono', 'eLEXTYPE_RESERVED10', 'SDTReplacement',
    'eLEXTYPE_PRIVATE12', 'DISPID_SVGetAudioInputs',
    'DISPID_SRRAudioFormat', 'eLEXTYPE_PRIVATE13', 'SPVPRI_OVER',
    'SPVPRIORITY', 'DISPID_SpeechPhraseAlternate',
    'SAFTADPCM_44kHzMono', 'SVSFParseMask', 'SPLEXICONTYPE',
    'SPXRO_Alternates_SML', 'SVSFUnusedFlags',
    'DISPID_SABIMinNotification', 'SPSMF_UPS', 'SPFM_CREATE_ALWAYS',
    'DISPID_SLWPronunciations', 'SPSTREAMFORMATTYPE', 'SPPHRASE',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SRGDictationSetState',
    'SAFTADPCM_22kHzStereo', 'SPAR_High', 'SPEI_MIN_SR',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SRCEFalseRecognition',
    'SREPrivate', 'SAFTCCITT_ALaw_44kHzStereo', 'SPPROPERTYINFO',
    'DISPID_SVPriority', 'SPAS_PAUSE', 'SRSEIsSpeaking',
    'SpeechRecognizerState', 'SPVPRI_ALERT', 'SPEI_VISEME',
    'SDKLLocalMachine', 'SDA_No_Trailing_Space', 'SVP_8',
    'ISpeechResourceLoader', 'DISPID_SpeechWaveFormatEx',
    'SVSFPurgeBeforeSpeak', 'SpeechVoicePriority', 'SECFDefault',
    'SpeechPropertyResourceUsage', 'SPCT_SUB_DICTATION',
    'IInternetSecurityMgrSite', 'SPEI_INTERFERENCE',
    'eLEXTYPE_PRIVATE15', 'ISpeechXMLRecoResult',
    'IInternetSecurityManager', 'DISPID_SVEVoiceChange',
    'DISPID_SGRId', 'eLEXTYPE_PRIVATE17', 'DISPID_SPIGetText',
    'DISPID_SMSAMMHandle', 'SVSFIsFilename', 'SRAExport',
    'SPAR_Unknown', 'SPPS_NotOverriden', 'ISpeechPhraseReplacement',
    'DISPID_SRCEPhraseStart', 'ISpeechLexicon', 'SECFNoSpecialChars',
    'DISPID_SPRsCount', 'Speech_StreamPos_RealTime', 'SpeechWordType',
    'DISPID_SDKSetLongValue', 'DISPID_SRCVoicePurgeEvent', 'SVP_3',
    'DISPIDSPRG', 'DISPID_SOTRemoveStorageFileName', 'SP_VISEME_16',
    'SASRun', 'SAFT32kHz8BitStereo', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SOTCId', 'DISPID_SBSRead', 'eLEXTYPE_PRIVATE14',
    'DISPID_SRStatus', 'DISPID_SRCPause', 'STSF_LocalAppData',
    'SpeechTokenValueCLSID', 'SPBO_PAUSE', 'DISPID_SPPFirstElement',
    'DISPID_SADefaultFormat', 'SP_VISEME_3', 'SREPhraseStart',
    'ISpProperties', 'SVEPhoneme', 'SpeechCategoryVoices',
    'DISPID_SpeechPhraseInfo',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SVPAlert',
    'SpeechCategoryRecoProfiles', 'SAFT12kHz8BitMono',
    'DISPID_SVSInputWordLength', 'SPSFunction', 'SpeechRunState',
    'SpInprocRecognizer', 'SpeechCategoryRecognizers',
    'SpeechLoadOption', 'DISPID_SRCBookmark', 'ISpXMLRecoResult',
    'SpFileStream', 'SpeechRecoEvents', 'DISPID_SGRSTType',
    'SSTTDictation', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SpeechRecoResult', 'SpAudioFormat', 'SAFTADPCM_22kHzMono',
    'DISPID_SGRs_NewEnum', 'SpObjectTokenCategory', 'SVSFParseSapi',
    'SPPS_Verb', 'SpeechDiscardType', 'DISPID_SPRText',
    'SPPS_RESERVED1', 'SpPhraseInfoBuilder', 'SVSFlagsAsync',
    ...
    'DISPID_SRGetPropertyString', 'SPPHRASEPROPERTY',
    'SPEI_ADAPTATION', 'DISPID_SGRAttributes', 'SpeechLexiconType',
    'SpeechGrammarTagUnlimitedDictation'
]

_check_version('1.1.14', 1633528313.040423)
